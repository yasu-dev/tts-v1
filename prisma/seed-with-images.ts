...
async function main() {
  ...
  const demoProducts = [
    ...
    { name: 'Panasonic S5 II', sku: 'CAM-009', category: 'camera', price: 215000, status: 'maintenance', condition: 'fair' },
    ...
    { name: 'TAG Heuer Carrera', sku: 'WATCH-009', category: 'watch', price: 350000, status: 'maintenance', condition: 'fair' },
    ...
    { name: 'Profoto B10 ストロボ', sku: 'OTHER-009', category: 'other', price: 168000, status: 'maintenance', condition: 'poor' },
