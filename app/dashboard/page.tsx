        ...
        <div className="intelligence-card global">
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-display font-bold text-nexus-text-primary mb-1">ダッシュボード</h1>
                ...
                <p className="text-nexus-text-secondary mt-2 text-sm">
                  全体の業績と主要指標を一目で確認
                </p>
              </div>
            ...
            <div className="holo-table">
              <table className="w-full text-xs">
                <thead className="holo-header">
                  <tr>
                    <th className="text-left py-1.5 px-2.5 text-xs">注文ID</th>
                    <th className="text-left py-1.5 px-2.5 text-xs">顧客</th>
                    <th className="text-left py-1.5 px-2.5 text-xs">販売者</th>
                    <th className="text-center py-1.5 px-2.5 text-xs">認証</th>
                    <th className="text-right py-1.5 px-2.5 text-xs">商品数</th>
                    <th className="text-right py-1.5 px-2.5 text-xs">金額</th>
                    <th className="text-center py-1.5 px-2.5 text-xs">ステータス</th>
                    <th className="text-left py-1.5 px-2.5 text-xs">地域</th>
                  </tr>
                </thead>
                <tbody className="holo-body">
                  {orders.map((order) => (
                    <tr key={order.id} className="holo-row">
                      <td className="font-mono text-nexus-text-primary py-1.5 px-2.5 text-xs">{order.id}</td>
                      <td className="font-medium py-1.5 px-2.5 text-xs">{order.customer}</td>
                      <td className="py-1.5 px-2.5 text-xs">{order.seller}</td>
                      ...
                      <td className="text-right font-display py-1.5 px-2.5 text-xs">{order.items}</td>
                      <td className="text-right font-display font-bold py-1.5 px-2.5 text-xs">{order.value}</td>
                      <td className="text-center py-1.5 px-2.5">
                      ...
                      <td className="py-1.5 px-2.5 text-xs">{order.region}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
