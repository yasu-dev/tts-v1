  ...
  return (
    <div className="space-y-8">
      ...
      <div className="intelligence-card global">
        <div className="p-8">
          <div className="mb-6">
            <h3 className="text-2xl font-display font-bold text-nexus-text-primary">在庫サマリー</h3>
            <p className="text-nexus-text-secondary mt-1">リアルタイム在庫状況</p>
          </div>
            ...
            <div className="intelligence-card europe">
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="status-badge success">価値</span>
                </div>
                <div className="metric-value font-display text-3xl font-bold text-nexus-text-primary">
      ...
      <div className="intelligence-card global">
        <div className="p-8">
          <div className="mb-6">
            <h3 className="text-xl font-display font-bold text-nexus-text-primary">ステータス別在庫</h3>
          </div>
            ...
            {Object.entries(stats.statusStats).map(([status, count]) => (
              <div key={status} className="intelligence-card americas">
                <div className="p-4">
                  ...
                  <div className="text-sm font-medium text-nexus-text-secondary">
                    {status}
                  </div>
                </div>
              </div>
      ...
      <div className="intelligence-card global">
        <div className="p-8">
          <div className="mb-6">
            <h3 className="text-xl font-display font-bold text-nexus-text-primary">カテゴリー別在庫</h3>
          </div>
      ...
      <div className="text-center text-nexus-text-muted text-xs">
