...
// DashboardLayoutとProfileMenuのアイコンを統合した統一アイコンシステム
...
// アイコンのタイプ定義
export type IconType = keyof typeof unifiedIcons;

// アイコンを取得するヘルパー関数
export const getUnifiedIcon = (iconType: IconType, className?: string): React.ReactElement => {
  const icon = unifiedIcons[iconType];
  if (!icon) {
    // フォールバック用のデフォルトアイコン
    return (
