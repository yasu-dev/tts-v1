        ...
        <div className="flex items-center gap-8 z-10">
          ...
          <div className="flex items-center gap-6">
            <div className="nexus-logo relative">
              <div className="absolute inset-[-3px] bg-gradient-to-r from-primary-blue via-nexus-yellow via-nexus-red via-nexus-green via-nexus-purple to-nexus-cyan rounded-[21px] opacity-60 -z-10"></div>
