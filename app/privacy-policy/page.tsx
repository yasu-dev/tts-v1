        ...
        <NexusCard className="p-8">
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="bg-nexus-bg-tertiary p-6 rounded-lg">
                <p className="text-nexus-text-primary font-semibold mb-2">
                  株式会社THE WORLD DOOR
                </p>
                <p className="text-nexus-text-secondary">
                  住所：神奈川県相模原市南区相模大野3-13-15 第3タカビル6階<br />
                  電話番号：042-705-1966<br />
                  メールアドレス：info@the-world-door.com<br />
                  受付時間：平日 9:00〜18:00
                </p>
              </div>
            </section>
